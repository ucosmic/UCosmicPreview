...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets3A3708CC2C0E5AC2AE9F34FC786D81FF99BB5FFB87BD5E6B9EEE7D04D1EA7359))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets3A3708CC2C0E5AC2AE9F34FC786D81FF99BB5FFB87BD5E6B9EEE7D04D1EA7359 : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySets3A3708CC2C0E5AC2AE9F34FC786D81FF99BB5FFB87BD5E6B9EEE7D04D1EA7359()
        {
            this.EdmEntityContainerName = "UCosmicContext";
            this.StoreEntityContainerName = "CodeFirstDatabase";
            this.HashOverMappingClosure = "8cf6cd28cf99791b386a46a9f0b109565f6f120816c2b5e1e7044ad5711fa597";
            this.HashOverAllExtentViews = "a31280dfd7134bb67b0ac8a9fda41f1d9380d3d18b34f98816e2d8988f9677fd";
            this.ViewCount = 131;
        }
    ...
    FROM (
        SELECT 
            ...
            True AS _from0
        FROM UCosmicContext.LooseFiles AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for UCosmicContext.LooseFiles
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView1()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("UCosmicContext.LooseFiles", @"
    SELECT VALUE -- Constructing LooseFiles
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView28()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CodeFirstDatabase.EstablishmentType", "\r\n    SELECT VALUE -- Constructing EstablishmentType\r\n        [CodeFirstDatabaseS" +
                    "chema.EstablishmentType](T1.EstablishmentType_RevisionId, T1.EstablishmentType_C" +
                    "ategoryCode, T1.EstablishmentType_EnglishName, T1.EstablishmentType_EnglishPlura" +
                    "lName, T1.EstablishmentType_EntityId, T1.EstablishmentType_CreatedOnUtc, T1.Esta" +
                    "blishmentType_CreatedByPrincipal, T1.EstablishmentType_UpdatedOnUtc, T1.Establis" +
                    "hmentType_UpdatedByPrincipal, T1.EstablishmentType_Version, T1.EstablishmentType" +
                    "_IsCurrent, T1.EstablishmentType_IsArchived, T1.EstablishmentType_IsDeleted)\r\n  " +
                    "  FROM (\r\n        SELECT \r\n            T.RevisionId AS EstablishmentType_Revisio" +
                    "nId, \r\n            T.CategoryCode AS EstablishmentType_CategoryCode, \r\n         " +
                    "   T.EnglishName AS EstablishmentType_EnglishName, \r\n            T.EnglishPlural" +
                    "Name AS EstablishmentType_EnglishPluralName, \r\n            T.EntityId AS Establi" +
                    "shmentType_EntityId, \r\n            T.CreatedOnUtc AS EstablishmentType_CreatedOn" +
                    "Utc, \r\n            T.CreatedByPrincipal AS EstablishmentType_CreatedByPrincipal," +
                    " \r\n            T.UpdatedOnUtc AS EstablishmentType_UpdatedOnUtc, \r\n            T" +
                    ".UpdatedByPrincipal AS EstablishmentType_UpdatedByPrincipal, \r\n            T.Ver" +
                    "sion AS EstablishmentType_Version, \r\n            T.IsCurrent AS EstablishmentTyp" +
    ...
    SELECT VALUE -- Constructing EstablishmentCategory
        [CodeFirstDatabaseSchema.EstablishmentCategory](T1.EstablishmentCategory_Code, T1.EstablishmentCategory_EnglishName, T1.EstablishmentCategory_EnglishPluralName)
    FROM (
        SELECT 
            T.Code AS EstablishmentCategory_Code, 
            T.EnglishName AS EstablishmentCategory_EnglishName, 
            T.EnglishPluralName AS EstablishmentCategory_EnglishPluralName, 
            True AS _from0
    ...
    SELECT VALUE -- Constructing EmailConfirmation
        [CodeFirstDatabaseSchema.EmailConfirmation](T1.EmailConfirmation_Id, T1.EmailConfirmation_PersonId, T1.EmailConfirmation_EmailAddressNumber, T1.EmailConfirmation_Token, T1.EmailConfirmation_SecretCode, T1.EmailConfirmation_Ticket, T1.EmailConfirmation_Intent, T1.EmailConfirmation_IssuedOnUtc, T1.EmailConfirmation_ExpiresOnUtc, T1.EmailConfirmation_RedeemedOnUtc, T1.EmailConfirmation_RetiredOnUtc)
    FROM (
        SELECT 
            ...
            T.IntentText AS EmailConfirmation_Intent, 
            ...
            T.RetiredOnUtc AS EmailConfirmation_RetiredOnUtc, 
            True AS _from0
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(3861);
            ...
            viewString.Append("eement_Status, T3.InstitutionalAgreement_Visibility, T3.InstitutionalAgreement_E");
            viewString.Append("ntityId, T3.InstitutionalAgreement_CreatedOnUtc, T3.InstitutionalAgreement_Creat");
            viewString.Append("edByPrincipal, T3.InstitutionalAgreement_UpdatedOnUtc, T3.InstitutionalAgreement");
            viewString.Append("_UpdatedByPrincipal, T3.InstitutionalAgreement_Version, T3.InstitutionalAgreemen");
            viewString.Append("t_IsCurrent, T3.InstitutionalAgreement_IsArchived, T3.InstitutionalAgreement_IsD");
            viewString.Append("eleted, T3.InstitutionalAgreement_UmbrellaId)\r\n    FROM (\r\n        SELECT T1.Ins");
            viewString.Append("titutionalAgreement_RevisionId, T1.InstitutionalAgreement_IsTitleDerived, T1.Ins");
            viewString.Append("titutionalAgreement_Title, T1.InstitutionalAgreement_Type, T1.InstitutionalAgree");
            viewString.Append("ment_StartsOn, T1.InstitutionalAgreement_ExpiresOn, T1.InstitutionalAgreement_Is");
            viewString.Append("ExpirationEstimated, T1.InstitutionalAgreement_Description, T1.InstitutionalAgre");
            viewString.Append("ement_IsAutoRenew, T1.InstitutionalAgreement_Status, T1.InstitutionalAgreement_V");
            viewString.Append("isibility, T1.InstitutionalAgreement_EntityId, T1.InstitutionalAgreement_Created");
            viewString.Append("OnUtc, T1.InstitutionalAgreement_CreatedByPrincipal, T1.InstitutionalAgreement_U");
            viewString.Append("pdatedOnUtc, T1.InstitutionalAgreement_UpdatedByPrincipal, T1.InstitutionalAgree");
            viewString.Append("ment_Version, T1.InstitutionalAgreement_IsCurrent, T1.InstitutionalAgreement_IsA");
            viewString.Append("rchived, T1.InstitutionalAgreement_IsDeleted, T2.InstitutionalAgreement_Umbrella");
            viewString.Append("Id, T1._from0, (T2._from1 AND T2._from1 IS NOT NULL) AS _from1\r\n        FROM  (\r");
            viewString.Append("\n            SELECT \r\n                T.RevisionId AS InstitutionalAgreement_Rev");
            viewString.Append("isionId, \r\n                T.IsTitleDerived AS InstitutionalAgreement_IsTitleDer");
            viewString.Append("ived, \r\n                T.Title AS InstitutionalAgreement_Title, \r\n             ");
            viewString.Append("   T.Type AS InstitutionalAgreement_Type, \r\n                T.StartsOn AS Instit");
            viewString.Append("utionalAgreement_StartsOn, \r\n                T.ExpiresOn AS InstitutionalAgreeme");
            viewString.Append("nt_ExpiresOn, \r\n                T.IsExpirationEstimated AS InstitutionalAgreemen");
            viewString.Append("t_IsExpirationEstimated, \r\n                T.Description AS InstitutionalAgreeme");
            viewString.Append("nt_Description, \r\n                T.IsAutoRenew AS InstitutionalAgreement_IsAuto");
            viewString.Append("Renew, \r\n                T.Status AS InstitutionalAgreement_Status, \r\n          ");
            viewString.Append("      T.VisibilityText AS InstitutionalAgreement_Visibility, \r\n                T");
            viewString.Append(".EntityId AS InstitutionalAgreement_EntityId, \r\n                T.CreatedOnUtc A");
            viewString.Append("S InstitutionalAgreement_CreatedOnUtc, \r\n                T.CreatedByPrincipal AS");
            viewString.Append(" InstitutionalAgreement_CreatedByPrincipal, \r\n                T.UpdatedOnUtc AS ");
            viewString.Append("InstitutionalAgreement_UpdatedOnUtc, \r\n                T.UpdatedByPrincipal AS I");
            viewString.Append("nstitutionalAgreement_UpdatedByPrincipal, \r\n                T.Version AS Institu");
            viewString.Append("tionalAgreement_Version, \r\n                T.IsCurrent AS InstitutionalAgreement");
            ...
            viewString.Append("      True AS _from0\r\n            FROM UCosmicContext.InstitutionalAgreements AS");
            viewString.Append(" T) AS T1\r\n            LEFT OUTER JOIN (\r\n            SELECT \r\n                K");
            viewString.Append("ey(T.InstitutionalAgreement_Umbrella_Source).RevisionId AS InstitutionalAgreemen");
            viewString.Append("t_RevisionId, \r\n                Key(T.InstitutionalAgreement_Umbrella_Target).Re");
            viewString.Append("visionId AS InstitutionalAgreement_UmbrellaId, \r\n                True AS _from1\r");
            viewString.Append("\n            FROM UCosmicContext.InstitutionalAgreement_Umbrella AS T) AS T2\r\n  ");
            viewString.Append("          ON T1.InstitutionalAgreement_RevisionId = T2.InstitutionalAgreement_Re");
    ...
    SELECT VALUE -- Constructing Activity
        [CodeFirstDatabaseSchema.Activity](T1.Activity_PersonId, T1.Activity_Number, T1.Activity_EntityId, T1.Activity_Mode, T1.Activity_Title, T1.Activity_Content, T1.Activity_StartsOn, T1.Activity_EndsOn, T1.Activity_DraftedTitle, T1.Activity_DraftedContent, T1.Activity_DraftedStartsOn, T1.Activity_DraftedEndsOn, T1.Activity_CreatedOn, T1.Activity_UpdatedOn)
    FROM (
        SELECT 
            T.PersonId AS Activity_PersonId, 
            T.Number AS Activity_Number, 
            T.EntityId AS Activity_EntityId, 
            T.ModeText AS Activity_Mode, 
            T.Values.Title AS Activity_Title, 
            T.Values.Content AS Activity_Content, 
            T.Values.StartsOn AS Activity_StartsOn, 
            T.Values.EndsOn AS Activity_EndsOn, 
            T.DraftedValues.Title AS Activity_DraftedTitle, 
            T.DraftedValues.Content AS Activity_DraftedContent, 
            T.DraftedValues.StartsOn AS Activity_DraftedStartsOn, 
            T.DraftedValues.EndsOn AS Activity_DraftedEndsOn, 
            T.CreatedOn AS Activity_CreatedOn, 
            T.UpdatedOn AS Activity_UpdatedOn, 
            True AS _from0
        FROM UCosmicContext.Activities AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for CodeFirstDatabase.ActivityTag
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView49()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CodeFirstDatabase.ActivityTag", @"
    SELECT VALUE -- Constructing ActivityTag
        [CodeFirstDatabaseSchema.ActivityTag](T1.ActivityTag_ActivityPersonId, T1.ActivityTag_ActivityNumber, T1.ActivityTag_Number, T1.ActivityTag_Text, T1.ActivityTag_DomainType, T1.ActivityTag_DomainKey)
    FROM (
        SELECT 
            T.ActivityPersonId AS ActivityTag_ActivityPersonId, 
            T.ActivityNumber AS ActivityTag_ActivityNumber, 
            T.Number AS ActivityTag_Number, 
            T.Text AS ActivityTag_Text, 
            T.DomainTypeText AS ActivityTag_DomainType, 
            T.DomainKey AS ActivityTag_DomainKey, 
            True AS _from0
        FROM UCosmicContext.ActivityTags AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for CodeFirstDatabase.DraftedTag
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView50()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CodeFirstDatabase.DraftedTag", @"
    SELECT VALUE -- Constructing DraftedTag
        [CodeFirstDatabaseSchema.DraftedTag](T1.DraftedTag_ActivityPersonId, T1.DraftedTag_ActivityNumber, T1.DraftedTag_Number, T1.DraftedTag_Text, T1.DraftedTag_DomainType, T1.DraftedTag_DomainKey)
    FROM (
        SELECT 
            T.ActivityPersonId AS DraftedTag_ActivityPersonId, 
            T.ActivityNumber AS DraftedTag_ActivityNumber, 
            T.Number AS DraftedTag_Number, 
            T.Text AS DraftedTag_Text, 
            T.DomainTypeText AS DraftedTag_DomainType, 
            T.DomainKey AS DraftedTag_DomainKey, 
            True AS _from0
        FROM UCosmicContext.DraftedTags AS T
    ) AS T1");
        }
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView78()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("UCosmicContext.EstablishmentTypes", "\r\n    SELECT VALUE -- Constructing EstablishmentTypes\r\n        [UCosmic.Impl.Orm." +
                    "EstablishmentType](T1.EstablishmentType_RevisionId, T1.EstablishmentType_Categor" +
                    "yCode, T1.EstablishmentType_EnglishName, T1.EstablishmentType_EnglishPluralName," +
                    " T1.EstablishmentType_EntityId, T1.EstablishmentType_CreatedOnUtc, T1.Establishm" +
                    "entType_CreatedByPrincipal, T1.EstablishmentType_UpdatedOnUtc, T1.EstablishmentT" +
                    "ype_UpdatedByPrincipal, T1.EstablishmentType_Version, T1.EstablishmentType_IsCur" +
                    "rent, T1.EstablishmentType_IsArchived, T1.EstablishmentType_IsDeleted)\r\n    FROM" +
                    " (\r\n        SELECT \r\n            T.RevisionId AS EstablishmentType_RevisionId, \r" +
                    "\n            T.CategoryCode AS EstablishmentType_CategoryCode, \r\n            T.E" +
                    "nglishName AS EstablishmentType_EnglishName, \r\n            T.EnglishPluralName A" +
                    "S EstablishmentType_EnglishPluralName, \r\n            T.EntityId AS Establishment" +
                    "Type_EntityId, \r\n            T.CreatedOnUtc AS EstablishmentType_CreatedOnUtc, \r" +
                    "\n            T.CreatedByPrincipal AS EstablishmentType_CreatedByPrincipal, \r\n   " +
                    "         T.UpdatedOnUtc AS EstablishmentType_UpdatedOnUtc, \r\n            T.Updat" +
                    "edByPrincipal AS EstablishmentType_UpdatedByPrincipal, \r\n            T.Version A" +
                    "S EstablishmentType_Version, \r\n            T.IsCurrent AS EstablishmentType_IsCu" +
                    "rrent, \r\n            T.IsArchived AS EstablishmentType_IsArchived, \r\n           " +
                    " T.IsDeleted AS EstablishmentType_IsDeleted, \r\n            True AS _from0\r\n     " +
    ...
    SELECT VALUE -- Constructing EstablishmentCategories
        [UCosmic.Impl.Orm.EstablishmentCategory](T1.EstablishmentCategory_Code, T1.EstablishmentCategory_EnglishName, T1.EstablishmentCategory_EnglishPluralName)
    FROM (
        SELECT 
            T.Code AS EstablishmentCategory_Code, 
            T.EnglishName AS EstablishmentCategory_EnglishName, 
    ...
    SELECT VALUE -- Constructing EmailConfirmations
        [UCosmic.Impl.Orm.EmailConfirmation](T1.EmailConfirmation_Id, T1.EmailConfirmation_PersonId, T1.EmailConfirmation_EmailAddressNumber, T1.EmailConfirmation_Token, T1.EmailConfirmation_SecretCode, T1.EmailConfirmation_Ticket, T1.EmailConfirmation_IntentText, T1.EmailConfirmation_IssuedOnUtc, T1.EmailConfirmation_ExpiresOnUtc, T1.EmailConfirmation_RedeemedOnUtc, T1.EmailConfirmation_RetiredOnUtc)
    FROM (
        SELECT 
            T.Id AS EmailConfirmation_Id, 
            T.PersonId AS EmailConfirmation_PersonId, 
            ...
            T.SecretCode AS EmailConfirmation_SecretCode, 
            T.Ticket AS EmailConfirmation_Ticket, 
            T.Intent AS EmailConfirmation_IntentText, 
            T.IssuedOnUtc AS EmailConfirmation_IssuedOnUtc, 
            T.ExpiresOnUtc AS EmailConfirmation_ExpiresOnUtc, 
            T.RedeemedOnUtc AS EmailConfirmation_RedeemedOnUtc, 
            T.RetiredOnUtc AS EmailConfirmation_RetiredOnUtc, 
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView93()
        {
            ...
            viewString.Append("_Status, T1.InstitutionalAgreement_VisibilityText, T1.InstitutionalAgreement_Ent");
            viewString.Append("ityId, T1.InstitutionalAgreement_CreatedOnUtc, T1.InstitutionalAgreement_Created");
            viewString.Append("ByPrincipal, T1.InstitutionalAgreement_UpdatedOnUtc, T1.InstitutionalAgreement_U");
            viewString.Append("pdatedByPrincipal, T1.InstitutionalAgreement_Version, T1.InstitutionalAgreement_");
            viewString.Append("IsCurrent, T1.InstitutionalAgreement_IsArchived, T1.InstitutionalAgreement_IsDel");
            viewString.Append("eted) WITH \r\n        RELATIONSHIP(CREATEREF(UCosmicContext.InstitutionalAgreemen");
            viewString.Append("ts, ROW(T1.[InstitutionalAgreement_Umbrella.InstitutionalAgreement_Umbrella_Targ");
            viewString.Append("et.RevisionId]),[UCosmic.Impl.Orm.InstitutionalAgreement]),[UCosmic.Impl.Orm.Ins");
            viewString.Append("titutionalAgreement_Umbrella],InstitutionalAgreement_Umbrella_Source,Institution");
            viewString.Append("alAgreement_Umbrella_Target) \r\n    FROM (\r\n        SELECT \r\n            T.Revisi");
            viewString.Append("onId AS InstitutionalAgreement_RevisionId, \r\n            T.IsTitleDerived AS Ins");
            viewString.Append("titutionalAgreement_IsTitleDerived, \r\n            T.Title AS InstitutionalAgreem");
            viewString.Append("ent_Title, \r\n            T.Type AS InstitutionalAgreement_Type, \r\n            T.");
            viewString.Append("StartsOn AS InstitutionalAgreement_StartsOn, \r\n            T.ExpiresOn AS Instit");
            viewString.Append("utionalAgreement_ExpiresOn, \r\n            T.IsExpirationEstimated AS Institution");
            viewString.Append("alAgreement_IsExpirationEstimated, \r\n            T.Description AS InstitutionalA");
            viewString.Append("greement_Description, \r\n            T.IsAutoRenew AS InstitutionalAgreement_IsAu");
            viewString.Append("toRenew, \r\n            T.Status AS InstitutionalAgreement_Status, \r\n            ");
            viewString.Append("T.Visibility AS InstitutionalAgreement_VisibilityText, \r\n            T.EntityId ");
            viewString.Append("AS InstitutionalAgreement_EntityId, \r\n            T.CreatedOnUtc AS Institutiona");
            viewString.Append("lAgreement_CreatedOnUtc, \r\n            T.CreatedByPrincipal AS InstitutionalAgre");
            viewString.Append("ement_CreatedByPrincipal, \r\n            T.UpdatedOnUtc AS InstitutionalAgreement");
            viewString.Append("_UpdatedOnUtc, \r\n            T.UpdatedByPrincipal AS InstitutionalAgreement_Upda");
            viewString.Append("tedByPrincipal, \r\n            T.Version AS InstitutionalAgreement_Version, \r\n   ");
            viewString.Append("         T.IsCurrent AS InstitutionalAgreement_IsCurrent, \r\n            T.IsArch");
            viewString.Append("ived AS InstitutionalAgreement_IsArchived, \r\n            T.IsDeleted AS Institut");
            viewString.Append("ionalAgreement_IsDeleted, \r\n            True AS _from0, \r\n            T.Umbrella");
            viewString.Append("Id AS [InstitutionalAgreement_Umbrella.InstitutionalAgreement_Umbrella_Target.Re");
    ...
    FROM (
        ...
        /// <Summary>
        /// return view for UCosmicContext.Activities
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView98()
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(2488);
            viewString.Append("\r\n    SELECT VALUE -- Constructing Activities\r\n        [UCosmic.Impl.Orm.Activit");
            viewString.Append("y](T3.Activity_PersonId, T3.Activity_Number, T3.Activity_EntityId, T3.Activity_M");
            viewString.Append("odeText, T3.Activity_Values, T3.Activity_DraftedValues, T3.Activity_CreatedOn, T");
            viewString.Append("3.Activity_UpdatedOn)\r\n    FROM (\r\n        SELECT -- Constructing Values\r\n      ");
            viewString.Append("      T2.Activity_PersonId, \r\n            T2.Activity_Number, \r\n            T2.A");
            viewString.Append("ctivity_EntityId, \r\n            T2.Activity_ModeText, \r\n            [UCosmic.Imp");
            viewString.Append("l.Orm.ActivityValues](T2.Activity_Values_Title, T2.Activity_Values_Content, T2.A");
            viewString.Append("ctivity_Values_StartsOn, T2.Activity_Values_EndsOn) AS Activity_Values, \r\n      ");
            viewString.Append("      T2.Activity_DraftedValues, \r\n            T2.Activity_CreatedOn, \r\n        ");
            viewString.Append("    T2.Activity_UpdatedOn\r\n        FROM (\r\n            SELECT -- Constructing Dr");
            viewString.Append("aftedValues\r\n                T1.Activity_PersonId, \r\n                T1.Activity");
            viewString.Append("_Number, \r\n                T1.Activity_EntityId, \r\n                T1.Activity_M");
            viewString.Append("odeText, \r\n                T1.Activity_Values_Title, \r\n                T1.Activi");
            viewString.Append("ty_Values_Content, \r\n                T1.Activity_Values_StartsOn, \r\n            ");
            viewString.Append("    T1.Activity_Values_EndsOn, \r\n                [UCosmic.Impl.Orm.ActivityValue");
            viewString.Append("s](T1.Activity_DraftedValues_Title, T1.Activity_DraftedValues_Content, T1.Activi");
            viewString.Append("ty_DraftedValues_StartsOn, T1.Activity_DraftedValues_EndsOn) AS Activity_Drafted");
            viewString.Append("Values, \r\n                T1.Activity_CreatedOn, \r\n                T1.Activity_U");
            viewString.Append("pdatedOn\r\n            FROM (\r\n                SELECT \r\n                    T.Per");
            viewString.Append("sonId AS Activity_PersonId, \r\n                    T.Number AS Activity_Number, \r");
            viewString.Append("\n                    T.EntityId AS Activity_EntityId, \r\n                    T.Mo");
            viewString.Append("de AS Activity_ModeText, \r\n                    T.Title AS Activity_Values_Title,");
            viewString.Append(" \r\n                    T.Content AS Activity_Values_Content, \r\n                 ");
            viewString.Append("   T.StartsOn AS Activity_Values_StartsOn, \r\n                    T.EndsOn AS Act");
            viewString.Append("ivity_Values_EndsOn, \r\n                    T.DraftedTitle AS Activity_DraftedVal");
            viewString.Append("ues_Title, \r\n                    T.DraftedContent AS Activity_DraftedValues_Cont");
            viewString.Append("ent, \r\n                    T.DraftedStartsOn AS Activity_DraftedValues_StartsOn,");
            viewString.Append(" \r\n                    T.DraftedEndsOn AS Activity_DraftedValues_EndsOn, \r\n     ");
            viewString.Append("               T.CreatedOn AS Activity_CreatedOn, \r\n                    T.Update");
            viewString.Append("dOn AS Activity_UpdatedOn, \r\n                    True AS _from0\r\n               ");
            viewString.Append(" FROM CodeFirstDatabase.Activity AS T\r\n            ) AS T1\r\n        ) AS T2\r\n   ");
            viewString.Append(" ) AS T3");
            return new System.Collections.Generic.KeyValuePair<string, string>("UCosmicContext.Activities", viewString.ToString());
        }
        
        /// <Summary>
        /// return view for UCosmicContext.ActivityTags
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView99()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("UCosmicContext.ActivityTags", @"
    SELECT VALUE -- Constructing ActivityTags
        [UCosmic.Impl.Orm.ActivityTag](T1.ActivityTag_ActivityPersonId, T1.ActivityTag_ActivityNumber, T1.ActivityTag_Number, T1.ActivityTag_Text, T1.ActivityTag_DomainTypeText, T1.ActivityTag_DomainKey)
    FROM (
        SELECT 
            T.ActivityPersonId AS ActivityTag_ActivityPersonId, 
            T.ActivityNumber AS ActivityTag_ActivityNumber, 
            T.Number AS ActivityTag_Number, 
            T.Text AS ActivityTag_Text, 
            T.DomainType AS ActivityTag_DomainTypeText, 
            T.DomainKey AS ActivityTag_DomainKey, 
            True AS _from0
        FROM CodeFirstDatabase.ActivityTag AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for UCosmicContext.DraftedTags
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView100()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("UCosmicContext.DraftedTags", @"
    SELECT VALUE -- Constructing DraftedTags
        [UCosmic.Impl.Orm.DraftedTag](T1.DraftedTag_ActivityPersonId, T1.DraftedTag_ActivityNumber, T1.DraftedTag_Number, T1.DraftedTag_Text, T1.DraftedTag_DomainTypeText, T1.DraftedTag_DomainKey)
    FROM (
        SELECT 
            T.ActivityPersonId AS DraftedTag_ActivityPersonId, 
            T.ActivityNumber AS DraftedTag_ActivityNumber, 
            T.Number AS DraftedTag_Number, 
            T.Text AS DraftedTag_Text, 
            T.DomainType AS DraftedTag_DomainTypeText, 
            T.DomainKey AS DraftedTag_DomainKey, 
            True AS _from0
        FROM CodeFirstDatabase.DraftedTag AS T
    ) AS T1");
        }
