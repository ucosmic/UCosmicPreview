...
namespace UCosmic.Www.Mvc.Areas.Identity.Controllers {
    public partial class UpdateEmailValueController {
        ...
        static readonly ActionParamsClass_ValidateValue s_params_ValidateValue = new ActionParamsClass_ValidateValue();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_ValidateValue ValidateValueParams { get { return s_params_ValidateValue; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_ValidateValue {
            public readonly string model = "model";
        }
