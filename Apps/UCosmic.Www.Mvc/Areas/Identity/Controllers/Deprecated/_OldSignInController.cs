...
//{
//    [EnforceHttps]
//    public partial class OldSignInController : BaseController
//    {
//        #region Construction & DI

//        //private readonly EstablishmentFinder _establishments;

//        //public OldSignInController(IQueryEntities entityQueries)
//        //{
...
//        //    var model = new OldSignInForm { ReturnUrl = returnUrl, };
...
//        ////[OpenTopTab(TopTabName.SignIn)]
//        //[OpenTopTab(TopTabName.Home)]
//        //public virtual ActionResult SignIn(OldSignInForm model)
//        //{
//        //    if (model != null)
//        //    {
...
//        //        }
//        //        return View(MVC.Identity.OldSignIn.Views.sign_in, model);
//        //    }
//        //    return HttpNotFound();
//        //}
...
//        //        return RedirectToAction(MVC.Identity.OldSignIn.SignOut(returnUrl));
//        //    }

//        //    if (!IsValidReturnUrl(returnUrl))
//        //    {
//        //        // clear the query string of invalid redirect URL's
//        //        return RedirectToAction(MVC.Identity.OldSignIn.SignOut());
//        //    }
...
//        //        {
//        //            Url.Action(MVC.Identity.OldSignIn.SignIn()),               // back to sign in
//        //            Url.Action(MVC.Identity.OldSignIn.SignOut()),              // over to sign out
//        //            Url.Action(MVC.Identity.OldSignUp.SendEmail()),            // over to sign up
//        //            "/sign-up/confirm-email/",                              // sign up email confirmation
//        //            "/confirm-password-reset/t-",                           // password reset email confirmation
//        //            Url.Action(MVC.Passwords.ForgotPassword.Get()),          // over to password reset
//        //        };
