...
//{
//    [EnforceHttps]
//    public partial class OldSignUpController : BaseController
//    {
...
//        public OldSignUpController(IQueryEntities entityQueries
...
//        {
//            var model = new OldSendEmailForm { EmailAddress = emailAddress, };
...
//        //[OpenTopTab(TopTabName.SignUp)]
//        [OpenTopTab(TopTabName.Home)]
//        [ValidateAntiForgeryToken(Salt = OldSignUpRouteMapper.SendEmail.Route)]
//        public virtual ActionResult SendEmail(OldSendEmailForm model)
//        {
...
//            return RedirectToAction(MVC.Identity.OldSignUp.ConfirmEmail(confirmation.Token, null));
//        }
...
//        {
//            var model = new OldConfirmEmailForm { SecretCode = secretCode, Token = token, };
//            var results = new List<ValidationResult>();
//            var isValid = Validator.TryValidateObject(model, new ValidationContext(model, null, null), results, true);
//            return isValid
//                ? Json(true)
...
//        //[OpenTopTab(TopTabName.SignUp)]
//        [OpenTopTab(TopTabName.Home)]
//        public virtual ActionResult ConfirmEmail(OldConfirmEmailForm model)
//        {
...
//                    return RedirectToAction(MVC.Identity.OldSignUp.CreatePassword());
//                }
//            }
//            return HttpNotFound();
//        }
...
//        {
//            var deniedView = MVC.Identity.OldSignUp.Views.confirm_denied;

//            // confirmations can only be redeemed within 2 hours of being registered.
//            if (confirmation.IsExpired)
//                return View(deniedView, new OldConfirmDeniedPage(OldConfirmDeniedPage.DeniedBecause.ConfirmationIsExpired));
...
//                return View(deniedView, new OldConfirmDeniedPage(OldConfirmDeniedPage.DeniedBecause.UserIsSignedUp));

//            if (_memberSigner.IsSignedUp(confirmation.EmailAddress.Value))
//                return View(deniedView, new OldConfirmDeniedPage(OldConfirmDeniedPage.DeniedBecause.MemberIsSignedUp));

//            // when person is not registered but confirmation has already been redeemed
//            if (confirmation.RedeemedOnUtc.HasValue)
//                return View(deniedView, new OldConfirmDeniedPage(OldConfirmDeniedPage.DeniedBecause.ConfirmationIsRedeemed));
...
//        //[OpenTopTab(TopTabName.SignUp)]
//        [OpenTopTab(TopTabName.Home)]
//        public virtual ActionResult CreatePassword(OldCreatePasswordForm model)
//        {
//            // need to get fresh data each time, to make sure user is not already registered
//            var token = TempData[ConfirmationTokenKey] as Guid?;
...
//                return RedirectToAction(MVC.Identity.OldSignUp.SignIn());
//            }
//            TempData.Remove(ConfirmationTokenKey);
//            return HttpNotFound();
//        }
...
//        {
//            var deniedView = MVC.Identity.OldSignUp.Views.create_denied;
...
//                return View(deniedView, new OldCreateDeniedPage(OldCreateDeniedPage.DeniedBecause.ConfirmationDoesNotExist));

//            // passwords can only be created within the expiration window
//            if (confirmation.IsExpired)
//                return View(deniedView, new OldCreateDeniedPage(OldCreateDeniedPage.DeniedBecause.ConfirmationIsExpired));

//            // when person is already registered cannot create member & password
//            if (confirmation.EmailAddress.Person.User != null
//                && confirmation.EmailAddress.Person.User.IsRegistered)
//                return View(deniedView, new OldCreateDeniedPage(OldCreateDeniedPage.DeniedBecause.UserIsSignedUp));

//            if (_memberSigner.IsSignedUp(confirmation.EmailAddress.Value))
//                return View(deniedView, new OldCreateDeniedPage(OldCreateDeniedPage.DeniedBecause.MemberIsSignedUp));
...
//            }
//            TempData.Remove(ConfirmationTokenKey);
//            return RedirectToAction(MVC.Identity.OldSignIn.SignIn());
//        }
