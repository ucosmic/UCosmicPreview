...
namespace UCosmic.Www.Mvc.Areas.Identity.Models
{
    public class UpdatePasswordForm : IReturnUrl
    {
        ...
        [Remote("ValidateCurrentPassword", "UpdatePassword", "Identity", HttpMethod = "POST")]
        ...
        [Remote("ValidateNewPasswordConfirmation", "UpdatePassword", "Identity", HttpMethod = "POST", AdditionalFields = "NewPassword")]
