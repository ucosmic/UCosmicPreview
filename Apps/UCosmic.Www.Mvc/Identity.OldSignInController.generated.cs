...
namespace UCosmic.Www.Mvc.Areas.Identity.Controllers {
    public partial class OldSignInController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected OldSignInController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OldSignInController Actions { get { return MVC.Identity.OldSignIn; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Identity";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "OldSignIn";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "OldSignIn";
        ...
        public class ViewNames {
            public readonly string _sign_on_status = "~/Areas/Identity/Views/OldSignIn/_sign-on-status.cshtml";
            public readonly string nav = "~/Areas/Identity/Views/OldSignIn/nav.cshtml";
            public readonly string sign_in_as = "~/Areas/Identity/Views/OldSignIn/sign-in-as.cshtml";
            public readonly string sign_in = "~/Areas/Identity/Views/OldSignIn/sign-in.cshtml";
            public readonly string sign_out = "~/Areas/Identity/Views/OldSignIn/sign-out.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_OldSignInController: UCosmic.Www.Mvc.Areas.Identity.Controllers.OldSignInController {
        public T4MVC_OldSignInController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult SignIn(UCosmic.Www.Mvc.Areas.Identity.Models.SignIn.OldSignInForm model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.SignIn);
