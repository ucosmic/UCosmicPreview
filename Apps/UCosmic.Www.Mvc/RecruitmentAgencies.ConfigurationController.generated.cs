...
namespace UCosmic.Www.Mvc.Areas.RecruitmentAgencies.Controllers {
    public partial class ConfigurationController {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ConfigurationController Actions { get { return MVC.RecruitmentAgencies.Configuration; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "RecruitmentAgencies";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewNames {
            public readonly string configure = "~/Areas/RecruitmentAgencies/Views/Configuration/configure.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_ConfigurationController: UCosmic.Www.Mvc.Areas.RecruitmentAgencies.Controllers.ConfigurationController {
