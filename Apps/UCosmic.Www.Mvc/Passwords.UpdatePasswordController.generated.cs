...
namespace UCosmic.Www.Mvc.Areas.Passwords.Controllers {
    public partial class UpdatePasswordController {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UpdatePasswordController Actions { get { return MVC.Passwords.UpdatePassword; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_UpdatePasswordController: UCosmic.Www.Mvc.Areas.Passwords.Controllers.UpdatePasswordController {
        ...
        public override System.Web.Mvc.JsonResult ValidateCurrentPassword(UCosmic.Www.Mvc.Areas.Passwords.Models.UpdatePasswordForm model) {
            var callInfo = new T4MVC_JsonResult(Area, Name, ActionNames.ValidateCurrentPassword);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }

        public override System.Web.Mvc.JsonResult ValidateNewPasswordConfirmation(UCosmic.Www.Mvc.Areas.Passwords.Models.UpdatePasswordForm model) {
            var callInfo = new T4MVC_JsonResult(Area, Name, ActionNames.ValidateNewPasswordConfirmation);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }

        public override System.Web.Mvc.ActionResult Post(UCosmic.Www.Mvc.Areas.Passwords.Models.UpdatePasswordForm model) {
