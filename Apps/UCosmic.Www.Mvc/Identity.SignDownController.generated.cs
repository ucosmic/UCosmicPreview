...
namespace UCosmic.Www.Mvc.Areas.Identity.Controllers {
    public partial class SignDownController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SignDownController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SignDownController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SignDownController Actions { get { return MVC.Identity.SignDown; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Identity";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SignDown";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SignDown";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_SignDownController: UCosmic.Www.Mvc.Areas.Identity.Controllers.SignDownController {
        public T4MVC_SignDownController() : base(Dummy.Instance) { }
