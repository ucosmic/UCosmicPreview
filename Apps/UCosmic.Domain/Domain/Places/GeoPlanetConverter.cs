...
{
    public static class GeoPlanetConverter
    {
        ...
        public static GeoPlanetPlace ToEntity(this NGeo.Yahoo.GeoPlanet.Place geoPlanetPlace)
        {
            return (geoPlanetPlace != null) ? Mapper.Map<GeoPlanetPlace>(geoPlanetPlace) : null;
        }

        public static GeoPlanetPlaceType ToEntity(this NGeo.Yahoo.GeoPlanet.PlaceType geoPlanetPlaceType)
        {
            return (geoPlanetPlaceType != null) ? Mapper.Map<GeoPlanetPlaceType>(geoPlanetPlaceType) : null;
        }

        public static Place ToPlace(this GeoPlanetPlace geoPlanetPlace)
        {
