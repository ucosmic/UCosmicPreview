...
{
    public static class GeoNamesConverter
    {
        ...
        public static GeoNamesToponym ToEntity(this NGeo.GeoNames.Toponym geoNamesToponym)
        {
            return (geoNamesToponym != null) ? Mapper.Map<GeoNamesToponym>(geoNamesToponym) : null;
        }

        public static GeoNamesCountry ToEntity(this NGeo.GeoNames.Country geoNamesCountry)
        {
            return (geoNamesCountry != null) ? Mapper.Map<GeoNamesCountry>(geoNamesCountry) : null;
        }

        public static PlaceName ToEntity(this GeoNamesAlternateName geoNamesAlternateName, LanguageFinder languages)
        {
        ...
        public static ICollection<PlaceName> ToEntities(this IEnumerable<GeoNamesAlternateName> geoNamesAlternateNames, LanguageFinder languages)
        {
        ...
        public static Place ToPlace(this GeoNamesToponym toponym)
        {
