...
namespace UCosmic.Www.Mvc.Areas.Identity
{
    ...
    {
        public ResetPasswordPage(IWebDriver browser) : base(browser) { }
        public override string Title { get { return "Reset Password"; } }
        public override string Path
        {
            get
            {
                var guid = Guid.NewGuid();
                return MVC.Identity.ResetPassword.Get(guid).AsPath()
