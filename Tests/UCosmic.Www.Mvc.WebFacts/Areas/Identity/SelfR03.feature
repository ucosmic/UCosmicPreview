...
Scenario Outline:My Change Email Spelling form changes spelling unsuccessfully with invalid inputs
	Given I have seen a link titled "Change spelling"
	And   I have clicked the link titled "Change spelling"
	And   I have seen a page at the "my/emails/[PathVar]/change-spelling" url
