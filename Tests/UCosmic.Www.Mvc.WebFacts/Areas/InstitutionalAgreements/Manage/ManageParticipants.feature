...
Scenario Outline: Add Participant to list
    ...
    Then I should see an autocomplete dropdown menu item "<ParticipantTarget>" for the Participant Search text field

    When I click the autocomplete dropdown menu item "<ParticipantTarget>" for the Participant Search text field
