...
Scenario Outline: Generate summary description based on participants, type, and status when adding an agreement
   ...
   Then I should <OrNot> see an autocomplete dropdown menu item "<Participant>" for the Participant Search text field
   And I should <OrNot> click the autocomplete dropdown menu item "<Participant>" for the Participant Search text field
