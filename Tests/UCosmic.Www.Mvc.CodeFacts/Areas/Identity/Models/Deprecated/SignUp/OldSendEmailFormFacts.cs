...
//    public class OldSendEmailFormFacts
...
//                results.Single().ErrorMessage.ShouldEqual(OldSendEmailForm.RequiredErrorMessage);
...
//                results.Count.ShouldEqual(1);
//                results.Single().ErrorMessage.ShouldNotBeNull();
//                results.Single().ErrorMessage.ShouldEqual(OldSendEmailForm.RegexErrorMessage);
//                results.Single().MemberNames.ShouldNotBeNull();
//                results.Single().MemberNames.Count().ShouldEqual(1);
//                results.Single().MemberNames.Single().ShouldEqual("EmailAddress");
//            }
...
//                results.Count.ShouldEqual(1);
//                results.Single().ErrorMessage.ShouldNotBeNull();
//                results.Single().ErrorMessage.ShouldEqual(string.Format(OldSendEmailForm.LengthErrorMessage, null, 200));
//                results.Single().MemberNames.ShouldNotBeNull();
//                results.Single().MemberNames.Count().ShouldEqual(1);
//                results.Single().MemberNames.Single().ShouldEqual("EmailAddress");
//            }
...
//                results.Count.ShouldEqual(1);
//                results.Single().ErrorMessage.ShouldNotBeNull();
//                results.Single().ErrorMessage.ShouldEqual(string.Format(OldSendEmailForm.IneligibleErrorMessage, "@invalid1.edu"));
//                results.Single().MemberNames.ShouldNotBeNull();
//                results.Single().MemberNames.Count().ShouldEqual(1);
//                results.Single().MemberNames.Single().ShouldEqual("EmailAddress");
...
//                results.Count.ShouldEqual(1);
//                results.Single().ErrorMessage.ShouldNotBeNull();
//                results.Single().ErrorMessage.ShouldEqual(string.Format(OldSendEmailForm.IneligibleErrorMessage, "@invalid2.edu"));
//                results.Single().MemberNames.ShouldNotBeNull();
//                results.Single().MemberNames.Count().ShouldEqual(1);
//                results.Single().MemberNames.Single().ShouldEqual("EmailAddress");
...
//                results.Count.ShouldEqual(1);
//                results.Single().ErrorMessage.ShouldNotBeNull();
//                results.Single().ErrorMessage.ShouldEqual(string.Format(OldSendEmailForm.AlreadySignedUpErrorMessage, model.EmailAddress));
//                results.Single().MemberNames.ShouldNotBeNull();
//                results.Single().MemberNames.Count().ShouldEqual(1);
//                results.Single().MemberNames.Single().ShouldEqual("EmailAddress");
