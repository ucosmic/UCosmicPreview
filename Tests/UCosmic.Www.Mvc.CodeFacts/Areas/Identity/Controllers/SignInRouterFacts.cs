...
{
    public static class SignInRouterFacts
    {
        ...
        public class TheGetRoute
        {
            ...
            private static readonly string Route = new SignInRouter.GetRoute().Url;

            private static Expression<Func<SignInController, ActionResult>> Action(string returnUrl)
            {
        ...
        public class ThePostRoute
        {
            ...
            private static readonly string Route = new SignInRouter.PostRoute().Url;
            private static readonly Expression<Func<SignInController, ActionResult>>
        ...
        [TestClass]
        public class TheValidatePasswordRoute
        {
            [TestMethod]
            public void Inbound_WithPost_MapsToAction()
            {
            ...
            private static readonly Expression<Func<SignInController, ActionResult>>
                Action = controller => controller.ValidatePassword(null);

            private static readonly string Url =
                new SignInRouter.ValidatePasswordRoute().Url.ToAppRelativeUrl();
        }
    }
}
