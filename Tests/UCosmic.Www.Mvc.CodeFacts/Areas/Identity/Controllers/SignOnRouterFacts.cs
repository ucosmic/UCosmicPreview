...
{
    public static class SignOnRouterFacts
    {
        ...
        public class TheGetRoute
        {
            ...
            private static readonly string Route = new SignOnRouter.GetRoute().Url;

            private static Expression<Func<SignOnController, ActionResult>> Action(string returnUrl)
            {
                Expression<Func<SignOnController, ActionResult>> action =
        ...
        public class ThePostRoute
        {
            ...
            private static readonly string Route = new SignOnRouter.PostRoute().Url;
            private static readonly Expression<Func<SignOnController, ActionResult>>
        ...
        public class TheValidateEmailAddressRoute
        {
            ...
            private static readonly string Url =
                new SignOnRouter.ValidateEmailAddressRoute().Url.ToAppRelativeUrl();
        }
    }
}
