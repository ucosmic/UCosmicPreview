...
//                mockQueries.Setup(p => p.Get<Language>()).Returns(null as IQueryable<Language>);
//                var queries = mockQueries.Object;
//                queries.ShouldNotBeNull();
//                queries.Get<Language>().ShouldBeNull();
//            }
...
//            {
//                var mockQueries = new Mock<IQueryEntities>(MockBehavior.Strict);
//                mockQueries.Setup(p => p.Get<Place>()).Returns(null as IQueryable<Place>);
//                var queries = mockQueries.Object;
//                queries.ShouldNotBeNull();
//                queries.Get<Place>().ShouldBeNull();
//            }
