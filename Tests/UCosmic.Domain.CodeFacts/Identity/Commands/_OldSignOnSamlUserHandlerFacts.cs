...
//                    ReceiveSamlAuthnResponseHandler.UntrustedIssuerExceptionMessageFormat, 
...
//                // ReSharper disable PossibleNullReferenceException
//                exception.Message.ShouldEqual(string.Format(
//                    ReceiveSamlAuthnResponseHandler.ResponseSignatureFailedVerificationMessageFormat,
//                        scenarioOptions.IssuerNameIdentifier));
//                // ReSharper restore PossibleNullReferenceException
//                scenarioOptions.MockQueryProcessor.Verify(m => 
//                    m.Execute(It.IsAny<GetEstablishmentBySamlEntityIdQuery>()), 
...
//        private static ReceiveSamlAuthnResponseHandler CreateSignOnSamlUserHandler(ScenarioInfo scenarioInfo)
//        {
...
//            return new ReceiveSamlAuthnResponseHandler(scenarioInfo.MockQueryProcessor.Object, 
//                null, scenarioInfo.MockUserSigner.Object);
//        }

//        private static ReceiveSamlAuthnResponseCommand CreateSignOnSamlUserCommand()
//        {
